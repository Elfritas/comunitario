...
<body>
    <div class="dashboard">
        ...
        <div class="user-profile" style="display: inline-block; vertical-align: middle; margin-left: 730px;">
            <img src="./assets/img/administrador.webp" alt="Foto de Usuario" class="user-photo" style="width: 65px; height: 65px; border-radius: 50%;">
        </div>
        <!-- Cards arriba -->
